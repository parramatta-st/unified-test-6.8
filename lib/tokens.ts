...
function pick(pronouns: PronounSet): PronounTokens {
  switch (pronouns) {
    case 'she/her':
      return { they: 'she', them: 'her', their: 'her', theirs: 'hers', is: 'is', has: 'has', does: 'does' };
    case 'he/him':
      return { they: 'he', them: 'him', their: 'his', theirs: 'his', is: 'is', has: 'has', does: 'does' };
    case 'they/them':
      return { they: 'they', them: 'them', their: 'their', theirs: 'theirs', is: 'are', has: 'have', does: 'do' };
    default:
      // Unknown pronouns: default to singular they so grammar still reads naturally.
      return { they: 'they', them: 'them', their: 'their', theirs: 'theirs', is: 'are', has: 'have', does: 'do' };
  }
}
...
export function applyTokens(
  ...
  const caps = (s: string) => (s ? s.charAt(0).toUpperCase() + s.slice(1) : s);
